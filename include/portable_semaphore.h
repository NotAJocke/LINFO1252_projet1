...
static inline sem_t *my_sem_init(uint32_t value) {
#ifdef __APPLE__
...
static inline int my_sem_destroy(sem_t *sem) {
#ifdef __APPLE__
...
// sem_wait and sem_post are equivalent for OSX and Linux => use default
// function calls
